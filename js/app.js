 ...
 */
    ...
    (() => {
        ...
        function formSubmit() {
            ...
            function formSent(form, responseResult = ``) {
                ...
                setTimeout((() => {
                    ...
                    form.classList.add("form__sent");
                    setTimeout((() => {
                        form.classList.contains("form__sent") ? form.classList.remove("form__sent") : null;
                    }), 3e3);
                }), 0);
                formValidate.formClean(form);
        ...
        const inputMasks = document.querySelectorAll(".input-template-form-01--userphone input");
